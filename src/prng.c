...
nwipe_prng_t nwipe_ascon_prf_prng = { "Ascon-PRF v1.3 (40 B/perm)",
                                      nwipe_ascon_prf_prng_init,
                                      nwipe_ascon_prf_prng_read };
...
int nwipe_ascon_prf_prng_read( NWIPE_PRNG_READ_SIGNATURE )
{
    ...
    {
        ascon_prf_prng_gen( (ascon_prf_prng_state_t*) *state, bufpos, SIZE_OF_ASCON_PRF_PRNG );
    ...
    if( remain )
    {
        ...
        ascon_prf_prng_gen( (ascon_prf_prng_state_t*) *state, tmp, SIZE_OF_ASCON_PRF_PRNG );
