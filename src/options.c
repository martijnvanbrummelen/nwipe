    ...
    while( 1 )
    {
        ...
        switch( nwipe_opt )
        {
            ...
            case 'p': /* PRNG option. */
                ...
                if( strcmp( optarg, "chacha20_prng" ) == 0 )
                {
...
void nwipe_options_log( void )
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                nwipe_log( NWIPE_LOG_NOTICE, "  prng     = ChaCha20 (EXPERIMENTAL!)" );
            }
...
void display_help()
{
    ...
    puts( "  -p, --prng=METHOD       PRNG option "
          "(mersenne|twister|isaac|isaac64|add_lagg_fibonacci_prng|chacha20_prng)\n" );
