    ...
    do
    {
        ...
        switch( focus )
        {
            ...
            case 5:
                ...
                mvwprintw( main_window, yy++, tab1, "ChaCha20 PRNG, securely implemented by Fabian Druschke" );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "within nwipe using OpenSSL, harnesses the efficiency and security of the" );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "ChaCha20 stream cipher to generate high-quality pseudo-random numbers.    " );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "                                                                            " );
                mvwprintw(
                    main_window, yy++, tab1, "This adaptation focuses on leveraging ChaCha20's design advantages,   " );
                mvwprintw(
                    main_window, yy++, tab1, "offering resilience against side-channel attacks and providing robust " );
                mvwprintw(
                    main_window, yy++, tab1, "randomness with a high-performance implementation suitable for secure " );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "data wiping operations within nwipe.                                   " );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "                                                                            " );
                mvwprintw( main_window,
                           yy++,
                           tab1,
                           "ChaCha20 is recommended by the IETF for its superior security properties" );
                mvwprintw(
                    main_window, yy++, tab1, "compared to AES in software-only environments, making it an excellent " );
                mvwprintw( main_window, yy++, tab1, "choice for generating unpredictable, high-entropy random data." );
                mvwprintw(
                    main_window, yy++, tab1, "Optimized for modern 64-bit CPUs without requiring dedicated hardware." );
                break;
        }
